    ...
    click: function click(e) {
      switch (e.linkType) {
        ...
        default:
          ...
          navigator.push({
            url: 'http://192.168.15.227:8081/dist/homepage/GoodsDetail.js',
            animated: "true"
          }, function (event) {
            console.log('结果回调');
          });
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("下拉刷新....")]), _c('loading-indicator', {
    staticClass: ["indicator"]
  })]), _vm._l((_vm.requestdata), function(ele) {
    return _c('div', {
      key: ele.layOutType
